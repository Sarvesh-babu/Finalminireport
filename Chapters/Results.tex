	...
	\section{Voltage Magnitude Graphs for Different Scenarios}
		...
		\begin{figure}
			\includegraphics[width=0.7\linewidth]{"sc 1 (00_00)"}
			\caption{Voltage loss plot
				 when EV is connected in Bus 2 and 18 of a 33 Bus system - Scenario 1 - case 1 }
		\end{figure}
		\begin{figure}
			\includegraphics[width=0.7\linewidth]{"sc 1 (00_20)"}
			\caption{Voltage loss plot when EV is connected in Bus 2 and 18 of a 33 Bus system - Scenario 1 - case 2}
		\end{figure}
		\begin{figure}
			\includegraphics[width=0.7\linewidth]{"sc 1 (00_40)"}
			\caption{Voltage loss plot when EV is connected in Bus 2 and 18 of a 33 Bus system - Scenario 1 - case 3}
		\end{figure}
		\begin{figure}
			\includegraphics[width=0.7\linewidth]{"sc 2 (00_00)"}
			\caption{Voltage loss plot when EV is connected in Bus 2 and 18 of a 33 Bus system - Scenario 2 - case 1}
		\end{figure}
		\begin{figure}
			\includegraphics[width=0.7\linewidth]{"sc 2 (00_20)"}
			\caption{Voltage loss plot when EV is connected in Bus 2 and 18 of a 33 Bus system - Scenario 2 - case 2}
		\end{figure}
		\begin{figure}
			\includegraphics[width=0.7\linewidth]{"sc 2 (00_40)"}
			\caption{Voltage loss plot when EV is connected in Bus 2 and 18 of a 33 Bus system - Scenario 2 - case 3}
		\end{figure}
